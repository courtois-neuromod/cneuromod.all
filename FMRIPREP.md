...
The above boilerplate text was adapted from a text automatically generated by fMRIPrep
with the express intention that users should copy and paste this
text into their manuscripts *unchanged*. The text can however be abbreviated or adapted for the particular subset of CneuroMod datasets used in a manuscript. 
