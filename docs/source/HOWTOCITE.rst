...
.. tip::
   ...
   **Required acknowledgement text**
   ...
   following paragraph in their acknowledgement section:
      ...
      *"The Courtois project on neural modelling was made possible by a generous
      donation from the Courtois foundation, administered by the Fondation Institut
      Gériatrie Montréal at CIUSSS du Centre-Sud-de-l'île-de-Montréal and University
      of Montreal. The Courtois NeuroMod team is based at Centre de Recherche de
      l'Institut Universitaire de Gériatrie de Montréal, with several other
...
We encourage including the name of the CNeuroMod release used in your analysis
(e.g. ``cneuromod-2020``) and any relevant excerpt from this documentation.
